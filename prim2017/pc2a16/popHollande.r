...
plot(c(min(hollande$mo), max(hollande$mo)), c(min(hollande$neto), max(ayrault$neto)), type = "n", main = "Aprobación neta (may2012-sep2015)", xlab = "mes", ylab = "%aprueban - % desaprueban")
abline(h=0, lty=2)
